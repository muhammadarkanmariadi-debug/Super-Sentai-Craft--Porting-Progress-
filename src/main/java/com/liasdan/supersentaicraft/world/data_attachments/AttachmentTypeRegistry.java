package com.liasdan.supersentaicraft.world.data_attachments;
...
public class AttachmentTypeRegistry {
    ...
    public static final Supplier<AttachmentType<Float>> TRANSFORMATION_TICK = REGISTRY.register(
            "transformation_tick", () -> AttachmentType.builder(() -> 0F).serialize(Codec.FLOAT).build()
    );
