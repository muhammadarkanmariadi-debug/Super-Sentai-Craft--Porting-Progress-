...
public class GoGoVItems {
	...
	public static final DeferredItem<Item> GO_RED_BADGE = ITEMS.register("go_red_badge",
            () -> new RangerFormChangeItem(new Item.Properties(),0,"","go_red","go_red_belt",
            		...
            		new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 40, 0,true,false)).ChangeBeltModel("rangerbeltextra.geo.json").AddToTabList(RangerTabs.GOGO_V));
	...
	public static final DeferredItem<Item> JEANNE_CRYSTAL_FRAGMENT = ITEMS.register("jeanne_fragment",
			() -> new RangerFormChangeItem(new Item.Properties(),0,"","zeek_jeanne","blank",
					new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 3,true,false),
					new MobEffectInstance(MobEffects.DIG_SPEED, 40, 2,true,false),
					new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 40, 0,true,false)).IsGlowing().SetShowFace());
	...
	public static final DeferredItem<BaseSwordItem> V_BOOMERANG_RED = ITEMS.register("v_boomerang_red",
			() -> new BaseSwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()).AddToTabList(RangerTabs.GOGO_V).ChangeRepairItem(GOGO_V_LOGO.get()));
	public static final DeferredItem<BaseSwordItem> V_BOOMERANG_BLUE = ITEMS.register("v_boomerang_blue",
			() -> new BaseSwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()).AddToTabList(RangerTabs.GOGO_V).ChangeRepairItem(GOGO_V_LOGO.get()));
	public static final DeferredItem<BaseSwordItem> V_BOOMERANG_GREEN = ITEMS.register("v_boomerang_green",
			() -> new BaseSwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()).AddToTabList(RangerTabs.GOGO_V).ChangeRepairItem(GOGO_V_LOGO.get()));
	public static final DeferredItem<BaseSwordItem> V_BOOMERANG_YELLOW = ITEMS.register("v_boomerang_yellow",
			() -> new BaseSwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()).AddToTabList(RangerTabs.GOGO_V).ChangeRepairItem(GOGO_V_LOGO.get()));
	public static final DeferredItem<BaseSwordItem> V_BOOMERANG_PINK = ITEMS.register("v_boomerang_pink",
			() -> new BaseSwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()).AddToTabList(RangerTabs.GOGO_V).ChangeRepairItem(GOGO_V_LOGO.get()));
