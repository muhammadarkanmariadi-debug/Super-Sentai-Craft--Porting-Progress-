...
import com.liasdan.supersentaicraft.items.sentai_30.boukenger.AccellularItem;
import com.liasdan.supersentaicraft.items.sentai_30.boukenger.GoGoChangerItem;
import com.liasdan.supersentaicraft.items.sentai_30.boukenger.SeikenZubaanItem;
...
public class BoukengerItems {
    ...
    public static final DeferredItem<SwordItem> BOUKEN_BO = ITEMS.register("bouken_bo",
            () -> new BaseSwordItem(Tiers.DIAMOND, 4, -2.4F, new Item.Properties()).IsDualWeapon().AddToTabList(RangerTabs.BOUKENGER).ChangeRepairItem(BOUKENGER_LOGO.get()));
    ...
    public static final DeferredItem<BaseSwordItem> BLOW_KNUCKLE = ITEMS.register("blow_knuckle",
