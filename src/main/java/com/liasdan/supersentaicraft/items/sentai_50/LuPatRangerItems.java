...
import com.liasdan.supersentaicraft.items.sentai_50.lupatranger.VSVehicleItem;
import com.liasdan.supersentaicraft.items.sentai_50.lupatranger.XChangerItem;
...
public class LuPatRangerItems {
	...
	public static final DeferredItem<SwordItem> BLADE_BOOMERANG = ITEMS.register("blade_boomerang",
			() -> new BaseSwordItem(Tiers.DIAMOND, 12, -2.4F, new Item.Properties()).AddToTabList(RangerTabs.LUPATRANGER).ChangeRepairItem(BLANK_STRIKER.get()));
