...
import com.liasdan.supersentaicraft.items.sentai_50.ryusoulger.BlankRyusoulItem;
import com.liasdan.supersentaicraft.items.sentai_50.ryusoulger.GaisoulKenItem;
import com.liasdan.supersentaicraft.items.sentai_50.ryusoulger.MosaChangerItem;
import com.liasdan.supersentaicraft.items.sentai_50.ryusoulger.RyusoulCaliburItem;
import com.liasdan.supersentaicraft.items.sentai_50.ryusoulger.RyusoulChangerItem;
import com.liasdan.supersentaicraft.items.sentai_50.ryusoulger.RyusoulItem;
...
public class RyusoulgerItems {
	...
	public static final DeferredItem<Item> HIEHIE_SOUL = ITEMS.register("hiehie_soul",
            () -> new RyusoulItem(new Item.Properties().rarity(Rarity.UNCOMMON),0,"ryusoul_hiehie","","blank",
            		...
            		new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 4,true,false),
            		new MobEffectInstance(EffectCore.SLASH, 40, 4,true,false),
            		new MobEffectInstance(EffectCore.GLIDE, 40, 5,true,false),
            		new MobEffectInstance(EffectCore.FROSTWALKER, 40, 0,true,false))
			.addAlternative(HIEHIE_SOUL_2.get()).ChangeSlot(2).BackToBase().ChangeModel("rangerwing.geo.json").ifFlyingModelResource("rangerwing.geo.json").AddCompatibilityList(RYUSOULGER).AddToTabList(RangerTabs.RYUSOULGER));
