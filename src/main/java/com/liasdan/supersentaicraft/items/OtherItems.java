...
public class OtherItems {
	...
	public static String[] SentaiRobo = new String[] { "battle_fever_robo", "dai_denzin", "sun_vulcan_robo", "gao_king",
			"gao_muscle", "gao_hunter",
	...
	public static final DeferredItem<Item> HACHIBUNGI = ITEMS.register("hachibungi",
			() -> new BaseItem(new Item.Properties()).AddToTabList(RangerTabs.MISC));

	public static final DeferredItem<Item> ROKUBUNGI = ITEMS.register("rokubungi",
			() -> new BaseItem(new Item.Properties()).AddToTabList(RangerTabs.MISC));

	public static final DeferredItem<Item> COMPASS_KYU = ITEMS.register("compass_kyu",
			() -> new BaseItem(new Item.Properties()).AddToTabList(RangerTabs.MISC));

	public static final DeferredItem<Item> JYOGI = ITEMS.register("jyogi",
			() -> new BaseItem(new Item.Properties()).AddToTabList(RangerTabs.MISC));
	...
	public static final DeferredItem<Item> SUPER_SENTAI_LOGO = ITEMS.register("super_sentai_logo",
			() -> new RangerFormChangeItem(new Item.Properties(), 0, "", "", "",
					...
					.ChangeSlot(2).addSwitchForm(BLANK_FORM.get()).AddCompatibilityList(SentaiRobo)
	...
	public static final DeferredItem<Item> TAIYOU_SENTAI_SUN_VULCAN_MUSIC_DISC = ITEMS.register(
			"taiyou_sentai_sun_vulcan_music_disc",
			() -> new Item(new Item.Properties().jukeboxPlayable(ModSounds.TAIYOU_SENTAI_SUN_VULCAN_KEY).stacksTo(1)));

	public static final DeferredItem<Item> HIKARI_SENTAI_MASKMAN_MUSIC_DISC = ITEMS.register(
			"hikari_sentai_maskman_music_disc",
	...
	public static final DeferredItem<Item> SAMURAI_SENTAI_SHINKENGER_MUSIC_DISC = ITEMS.register(
			"samurai_sentai_shinkenger_music_disc",
