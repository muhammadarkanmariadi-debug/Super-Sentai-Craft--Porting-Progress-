package com.liasdan.supersentaicraft.entity.ai;
...
public class RangedSwordgunAttackGoal<T extends Mob & RangedAttackMob> extends RangedBowAttackGoal<T> {
    ...
    public boolean canUse() {
        if (this.mob.getTarget() != null) {
            boolean swordgunMeleeOnly = ((this.mob instanceof BaseFootsoldierEntity entity && entity.getMeleeOnly()) || (this.mob instanceof BaseSummonEntity summon && summon.getMeleeOnly()));
    ...
    protected boolean isHoldingSwordgun() {
        return this.mob.isHolding(is -> is.is(ItemTags.create(ResourceLocation.fromNamespaceAndPath(SuperSentaiCraftCore.MODID, "arsenal/all_swordguns"))));
    }
