...
public class BaseFootsoldierEntity extends  Monster implements RangedAttackMob {
    ...
    private final MeleeAttackGoal meleeGoal = new  MeleeAttackGoal(this, 1.0D, false) {
        public void stop() {
            super.stop();
            BaseFootsoldierEntity.this.setAggressive(false);
        }

        public void start() {
            super.start();
            BaseFootsoldierEntity.this.setAggressive(true);
        }
    };
    ...
    public BaseFootsoldierEntity(EntityType<? extends BaseFootsoldierEntity> type, Level level) {
        super(type, level);
    ...
    protected void addBehaviourGoals() {
        ...
        this.targetSelector.addGoal(1, (new HurtByTargetGoal(this, BaseFootsoldierEntity.class)).setAlertOthers(ZombifiedPiglin.class));
    ...
    public void aiStep() {
        ...
        if (this.getTarget() != null && itemstack.is(ItemTags.create(ResourceLocation.fromNamespaceAndPath(SuperSentaiCraftCore.MODID, "arsenal/all_swordguns")))) {
