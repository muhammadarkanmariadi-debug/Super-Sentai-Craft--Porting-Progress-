...
public class UlarsEntity extends BaseFootsoldierEntity {

    public UlarsEntity(EntityType<? extends BaseFootsoldierEntity> type, Level level) {
        super(type, level);
        NAME="ular";
        this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(MobsItems.JAKOTSUKEN.get()));
    }
