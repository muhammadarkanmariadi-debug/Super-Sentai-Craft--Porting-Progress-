...
public class ServerPayloadHandler {
    ...
    public static void handleMechaAttack(final MechaAttackPayload data, final IPayloadContext context) {
        Player player = context.player();
        if (player.getVehicle() instanceof com.liasdan.supersentaicraft.entity.mecha.BaseMechaEntity mecha) {
            mecha.performAttack(data.attackType());
        }
    }
}